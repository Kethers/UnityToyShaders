...
public static class BuildFinalScene
{
	...
	public static void GenerateScene()
	{
		...
		var templateGo = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/RTWeekend/Prefabs/Sphere.prefab");
		var templateLambertian = AssetDatabase.LoadAssetAtPath<Material>("Assets/RTWeekend/Materials/RandomLambertian.mat");
		var templateMetal = AssetDatabase.LoadAssetAtPath<Material>("Assets/RTWeekend/Materials/RandomMetal.mat");
		var templateDielectric = AssetDatabase.LoadAssetAtPath<Material>("Assets/RTWeekend/Materials/RandomDielectric.mat");
